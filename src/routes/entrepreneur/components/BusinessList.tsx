  ...
  useEffect(() => {
    const fetchBusinesses = async () => {
      try {
        ...
        setError(`No se pudieron cargar los negocios: ${errorMessage}`);
    ...
    return (
      <div className="rounded-md bg-red-50 p-4">
        <div className="flex">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-red-800">Error al cargar los negocios</h3>
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Administra tus negocios y productos en un solo lugar
          </p>
        </div>
        <Button asChild>
      ...
      {businesses.length === 0 ? (
        <Card className="p-8 text-center">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900">Aún no tienes negocios registrados</h3>
          <p className="mt-2 text-sm text-gray-500">
            Comienza creando tu primer negocio para vender productos en nuestra plataforma.
          </p>
          <div className="mt-6">
            <Button asChild>
              <Link to="/entrepreneur/businesses/new">
