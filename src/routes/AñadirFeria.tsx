					...
					<div className="space-y-6">
						{initialLoading ? (
							...
							<>
								...
								{/* Owner */}
								<div>
									<label htmlFor="user_id" className="block text-sm font-medium mb-1 dark:text-white">Usuario dueño *</label>
									<select
										id="user_id"
										name="user_id"
								...
								{/* Actions */}
												<div className="flex justify-end gap-3 pt-2 border-t dark:border-cardDark">
