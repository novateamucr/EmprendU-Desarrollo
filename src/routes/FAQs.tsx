...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "No es una funcionalidad disponible actualmente.",
    },
  ];
    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex-1">
        <div className="flex items-center justify-center mt-16 md:mt-0 h-full">
          <div className="w-full mx-auto flex flex-col md:flex-row gap-8 md:gap-24 lg:gap-40 items-center mt-20">
            <div className="flex flex-col gap-3 p-6" style={{ minWidth: 260 }}>
              ...
              <p className="text-sm md:text-base mt-2">
                ¿Tienes más preguntas? <a href="/contactUs" className="hover:underline text-blue-400">Contáctanos</a>
              </p>
            </div>
            <div className="flex-1 overflow-y-auto p-4 md:p-8">
              <div className="space-y-4">
                {faqs.map((faq, index) => (
                  <div
                    key={index}
                    className="bg-white p-7 border rounded-3xl shadow-soft  transition-all duration-800 ease-in-out cursor-pointer hover:-translate-y-2"
                  ...
                  >
                    <div className="flex justify-between items-center">
                      ...
                      <button className="bg-blue-400 text-white rounded-full p-2 hover:bg-blue-500 transition ease-in-out duration-300">
                        {openIndex === index ? (
                          <ChevronUp size={18} />
                        ) : (
                          <ChevronDown size={18} />
