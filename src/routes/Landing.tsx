        ...
        return (
            <div className="bg-white text-gray-900">
                ...
                <section className="max-w-7xl mx-auto md:px-12 py-16 grid md:grid-cols-2 items-center gap-12">
                    <div>
                        <img src="img/logo.png" alt="EmprendU Logo" className="w-28 mb-6" />
                    ...
                    <div className="relative flex justify-center">
                        <img src="img/hero.png" alt="Hero" className="w-72 md:w-90 relative z-10" />
                        <img src="img/hero.png" alt="icono" className="absolute w-16 top-0 right-20" />
                        <img src="img/hero.png" alt="icono" className="absolute w-14 top-10 left-12" />
                        <img src="img/hero.png" alt="icono" className="absolute w-20 bottom-0 left-0" />
                        <img src="img/hero.png" alt="icono" className="absolute w-12 bottom-10 right-8" />
                    </div>
                </section>
                ...
                <footer className="bg-black text-white py-6">
                    <div className="max-w-6xl mx-auto flex justify-between items-center px-6 md:px-12">
                        ...
                        <img src="img/hero.png" alt="Logo" className="w-8 bg-white p-1 rounded-full" />
                    </div>
                </footer>
            </div>
        );
