          ...
          {selectedBusiness ? (
            <>
              {selectedBusiness.image_url ? (
                ...
                <div className="flex-shrink-0 h-8 w-8 rounded-md bg-primary-50 flex items-center justify-center">
        ...
        <div className="absolute z-10 mt-1 w-full rounded-md bg-white shadow-lg">
          <div className="p-2 border-b">
            <div className="relative">
              ...
              <input
                type="text"
                className="block w-full pl-10 pr-3 py-2 border border-gray-200 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                ...
                {filteredBusinesses.map((business) => (
                  <li key={business.id} className="group">
                    <button
                      type="button"
                      className={cn(
                        'w-full flex items-center px-4 py-2 text-sm text-left hover:bg-primary-50',
                        selectedBusiness?.id === business.id && 'bg-primary-50'
                      )}
                      onClick={() => {
                        onSelect(business);
                        setIsOpen(false);
                    ...
                    >
                      ...
                      <span className="ml-3 block truncate">{business.name}</span>
          ...
          <div className="border-t border-gray-100 px-4 py-2">
            <a
              href="/entrepreneur/businesses/new"
